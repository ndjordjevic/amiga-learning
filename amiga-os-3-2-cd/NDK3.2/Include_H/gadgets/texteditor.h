...
#define   GA_TEXTEDITOR_CursorX           (TEXTEDITOR_Dummy + 0x04) /* block number */
#define   GA_TEXTEDITOR_CursorY           (TEXTEDITOR_Dummy + 0x05) /* position in block */
...
#define   GA_TEXTEDITOR_FixedFont         (TEXTEDITOR_Dummy + 0x0a) /* not implemented */
...
#define   GA_TEXTEDITOR_SpacesPerTAB      (TEXTEDITOR_Dummy + 0x35)
...
#define   GA_TEXTEDITOR_AutoIndent        (TEXTEDITOR_Dummy + 0x3B)
...
#define   GF_TEXTEDITOR_SearchType_Mask        0x0013
...
#define   GF_TEXTEDITOR_Search_WholeWord     (1 << 6)
