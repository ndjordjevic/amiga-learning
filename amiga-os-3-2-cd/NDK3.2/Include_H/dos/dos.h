...
#define FIBB_HOLD      7        /* keep a pure module resident on its first use */
...
#define ID_LONG_DOS_DISK	(0x444F5306L)	/* 'DOS\6' */
#define ID_LONG_FFS_DISK	(0x444F5307L)	/* 'DOS\7' */
#define ID_COMPLONG_FFS_DISK	(0x444F5308L)	/* 'DOS\8' */
