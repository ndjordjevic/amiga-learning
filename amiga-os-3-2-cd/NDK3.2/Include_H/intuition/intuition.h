...
/*
**	$VER: intuition.h 47.6 (21.3.2021)
**
...
#define SUBMENU		0x0200  /* set to get standard submenu indicator (V47) */
...
#define MIF_SHIFTCOMMSEQ	0x0800 /* show shift key symbol, also used to parse if COMMSEQ is set */
#define MIF_EXTENDED	0x8000 /* reserved, clear for now */

/* FLAGS SET BY INTUITION */ 
#define MIF_RESERVED	0x0400	/* reserved, don't touch */
...
#define GTYP_ICONIFY            0x0090  /* Window iconify gadget (V46) */
...
#define GMORE_HIDDEN       0x00000010 /* This gadget is explicitly hidden/can't be drawn. V47 and V50. */
#define GMORE_BOOPSIGADGET 0x00000400 /* This gadget was (sub-)instantiated from gadgetclass. V47. */
#define GMORE_FREEIMAGE    0x00000800 /* This (BOOPSI) gadget automatically frees its GA_Image. V47. */
#define GMORE_PARENTHIDDEN 0x01000000 /* Parent is hidden, so this gadget is implicitly hidden too V47 */
...
#define PROPNEWLOOK	0x0010	/* set this if you want to get the new
				 * V36 look
				 */
#define SMARTKNOBIMAGE	0x0020	/* set this if your custom knob image is
...
#define INTUIWHEELDATA_VERSION 2 /* current version of the structure above */
...
#define IDCMP_EXTENDEDMOUSE 0x08000000 /* new for V47 & V51     */
...
#define CWCODE_HIDE     0x0002  /* Window was hidden (new for V46) */
#define CWCODE_SHOW     0x0003  /* Window was shown  (new for V46) */
...
#define WFLG_HASICONIFY     0x40000000  /* window has an iconfication gadget (V47) */
