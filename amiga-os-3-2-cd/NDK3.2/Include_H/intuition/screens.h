...
#define BARTRIMPEN	 (0x000B)	/* trim under screen-bar and menus	*/
/* New for V47, only present if DRI_VERSION >= 3: */
#define BARCONTOURPEN	 (0x000C)	/* contour above screen-bar and menus	*/

#define NUMDRIPENS	 (0x000D)
...
#define OSERR_NORTGBITMAP  (10)	/* couldn't allocate a RTG bitmap	*/
