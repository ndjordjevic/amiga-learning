...
/*
** Check whether a message comes from Rexx. This replaces the
** CheckRexxMsg() from amiga.lib. Note that other RVI functions
** are part of rexxsyslib.library now as well. This macro
** returns a boolean expression that is non-zero for a valid
** Rexx message and 0 otherwise. The argument is a struct
** RexxMsg to be tested.
*/

#define CHECKREXXMSG(msg) (RexxSysBase && (msg)->rm_LibBase == RexxSysBase && (msg)->rm_TaskBlock && IsRexxMsg(msg))
