...
struct FontRequester
{
    ...
    UBYTE        fo_SpecialDrawMode;/* Returned special drawmode (V47)  */
...
#define ASLFO_InitialSpecMode ASL_TB+139 /* Initial special drawmode (V50)   */
#define ASLFO_InitialCharSet  ASL_TB+134 /* Initial charset (V50)            */
...
#define ASLFO_DoSpecialMode   ASL_TB+140 /* Display DrawMode cycle gadget    */
                                         /* with options Text,               */
                                         /* Text+Background, Text+Outline,   */
                                         /* Text+Shadow? (V47)               */
#define ASLFO_DoCharSet       ASL_TB+135 /* reserved  */
...
#define ASLFO_OTagOnly        ASL_TB+136 /* Only allow bulletAPI fonts? (V46) */
#define ASLFO_ScalableOnly    ASL_TB+137 /* Only allow scalable bulletAPI fonts? (V46) */
...
#define ASLFO_CSFilterFunc    ASL_TB+138 /* Function to filter charsets	     */
...
/*****************************************************************************/
#define ASL_LAST_TAG ASL_TB+140
