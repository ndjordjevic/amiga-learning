...
#define WINDOW_IconNoDispose	(WINDOW_Dummy + 51)
	/* (BOOL) Don't dispose WINDOW_Icon. Defaults to FALSE (ie. dispose) */

#define WINDOW_NewMenu		(WINDOW_Dummy + 52)
	/* (struct NewMenu *) Let window.class create and layout the menus
	(useful for iconification and screenchanges) */

#define WINDOW_Qualifier	(WINDOW_Dummy + 53)
	/* (UWORD) Current qualifiers from IntuiMessage */
...
#define WPOS_FULLSCREEN          (5L)   /* Top-left of, and fill visible screen clip */
#define WPOS_ENTIRESCREEN        (6L)   /* Top-left of, and fill the entire screen
