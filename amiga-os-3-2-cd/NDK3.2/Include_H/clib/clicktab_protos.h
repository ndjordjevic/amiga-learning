...
/*
**	$Id: clicktab_protos.h 40.2 2001-07-08 12:50:28 olsen Exp $
**
...
VOID SetClickTabNodeAttrs( struct Node *node, Tag firstTag, ... );
VOID GetClickTabNodeAttrsA( struct Node *node, struct TagItem *tags );
VOID GetClickTabNodeAttrs( struct Node *node, Tag firstTag, ... );
