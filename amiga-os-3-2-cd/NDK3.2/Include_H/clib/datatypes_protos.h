...
/*
**	$Id: datatypes_protos.h 39.5 2001-07-05 20:39:52 olsen Exp $
**
...
ULONG SaveDTObject( Object *o, struct Window *win, struct Requester *req, CONST_STRPTR file, ULONG mode, LONG saveicon, Tag tag1, ... );
